...
public class AsyncRtspRequest {
    public RequestLine getRequestLine() {
        return new RequestLine() {
            @Override
            public String getUri() {
                return AsyncRtspRequest.this.getUri().toString();
            }

            @Override
            public com.koushikdutta.async.http.ProtocolVersion getProtocolVersion() {
            ...
            public String toString() {
                if (proxyHost != null)
                    return String.format(Locale.ENGLISH, "%s %s HTTP/1.1", mMethod, AsyncRtspRequest.this.getUri());
                String path = AsyncRtspRequest.this.getUri().getEncodedPath();
                if (path == null || path.length() == 0)
                    path = "/";
                String query = AsyncRtspRequest.this.getUri().getEncodedQuery();
    ...
    public AsyncRtspRequest setMethod(String method) {
        if (getClass() != AsyncRtspRequest.class)
            throw new UnsupportedOperationException("can't change method on a subclass of AsyncHttpRequest");
        mMethod = method;
        return this;
    }

    public AsyncRtspRequest(Uri uri, String method) {
    ...
    public AsyncRtspRequest(Uri uri, String method, Headers headers) {
        assert uri != null;
        mMethod = method;
        this.uri = uri;
        if (headers == null)
    ...
    public AsyncRtspRequest setFollowRedirect(boolean follow) {
    ...
    public AsyncRtspRequest setTimeout(int timeout) {
        mTimeout = timeout;
        return this;
    }

    public AsyncRtspRequest setHeader(String name, String value) {
        getHeaders().set(name, value);
        return this;
    }

    public AsyncRtspRequest addHeader(String name, String value) {
